% SW_COPY  Copyright and licence information on SEAWATER properties Software.
% =================================================================
% SW_COPY  sw_copy.m,v 1.0 12/18/2009 Copyright (C) Mostafa H Sharqawy et al., 2009
% SW_COPY  sw_copy.m,v 2.0 06/06/2012 Copyright (C) Mostafa H Sharqawy et al., 2012
% SW_COPY  sw_copy.m,v 3.0 07/22/2015 Copyright (C) Kishor G Nayar et al., 2015 (Beta release)
% SW_COPY  sw_copy.m,v 3.1 02/03/2016 Copyright (C) Kishor G Nayar et al., 2016 (First revised public release)
% SW_COPY  sw_copy.m,v 3.1.1 04/16/2016 Copyright (C) Kishor G Nayar et al., 2016 
% SW_COPY  sw_copy.m,v 3.1.2 07/08/2016 Copyright (C) Kishor G Nayar et al., 2016 
%
%      SOFTWARE LICENCE AGREEMENT
%
%      1.0 Grant of Licence
%
%      1.1  The Massachusetts Institute of Technology  (hereinafter referred
%           to as "MIT") hereby grants you (hereinafter referred
%           to as the "Licencee"), subject to the Licencee
%           agreeing to comply with the terms and conditions of this
%           Agreement, a non-transferable, non-exclusive licence to use
%           the computer programs described in this document (hereinafter
%           referred to  as the   "Software")  for  the  purpose of the
%           Licencee's computing activity.
%
%      1.2  MIT hereby grants the Licencee the right to  make copies
...
%           this  Agreement, MIT  shall  be under  no  obligation or
...
%
%           (a)  MIT  is  the  owner  of  all  copyright  and  other
...
%                of MIT's  ownership of the Software;
%
%           (c)  MIT reserves all rights  in the Software other than
...
%                without the approval of MIT.
%
%      3.0 Indemnity
%
%      3.1  To the full  extent permitted by  law, MIT  excludes any
...
%           demand.
%
%      3.5  The  Licencee's  obligation to  indemnify  MIT  and  its
...
%           or  not MIT is aware of  the occurrence of the breach at
%           the time that it happens.
%
%      4.2  MIT  may terminate the Licence on  reasonable grounds by
