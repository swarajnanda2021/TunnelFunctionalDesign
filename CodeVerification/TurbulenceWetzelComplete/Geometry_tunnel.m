...
close all
clc
%% Investigating the method of turbulence management by Wetzel
...
NN = 1000;
HTs = 0.327;          % Height of the tunnel test-section      
...
QPump        = 0.36;                                   % Pump output flowrate [m^2/hr]   
...
TI_Inlet = 0.05311;    % Inlet turbulence intensity array
if solidity == 0
    TIEvolMain = [];
...
% Tunnel Parameters
r       = 1e-4*0.5;               % Initial bubble radius [m]
